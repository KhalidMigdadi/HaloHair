...
namespace HaloHair.Controllers
{
    public class MenAppointmentsController : Controller
    {
        ...
        //[HttpPost]
        //public async Task<IActionResult> BookSlot(int userId, int barberId, int timeSlotId)
        //{
        //    var booking = new Booking
        //    {
        //        UserId = userId,
        ...
        //    if (timeSlot == null)
        //    {
        //        // إذا كان الـ Slot غير موجود، ننبه المستخدم
        //        return NotFound();
        //    }

        //    if (_context.Bookings.Any(b => b.TimeSlotId == timeSlotId))
        //    {
        //        // إذا كان الوقت محجوز مسبقًا
        //        TempData["Error"] = "هذا الوقت محجوز بالفعل.";
        //        return RedirectToAction("ShowAvailableSlots", new { barberId, date = timeSlot.StartTime.Date });
        //    }
